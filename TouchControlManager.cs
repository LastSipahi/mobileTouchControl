...
public class TouchControlManager : MonoBehaviour
{
    ...
    /// Pinch is complex, please ask Emre before changin anything. Camera frustum controls done.
            ...
            { 
                ...
                switch (touch.phase)
                {
                    ...
                    case TouchPhase.Moved:
                        if (UImanager.isClickMoveButton == false)
                        {
    ...
    private void LateUpdate()
    {
        if (Brake)
        {
            if (Pinching || InsideCity ) //prevent the sway effect occurs for pinching and in city move. Only for swipe.
            {
                DampingSpeed = 0;
            }
            else
